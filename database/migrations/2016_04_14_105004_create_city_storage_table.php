...
class CreateCityStorageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('db_city', function (Blueprint $table) {
        ...
        Schema::create('db_region', function (Blueprint $table) {
            $table->increments('region_id')->unsigned();
            $table->integer('country_id')->unsigned();
            $table->integer('city_id')->unsigned();
            $table->string('name', 128)->default('');
 ...
 (11364, 11060, 11363, 'Кофу');
    ...
    {
        Schema::drop('db_region');
        Schema::drop('db_country');
        Schema::drop('db_city');
    }
}
