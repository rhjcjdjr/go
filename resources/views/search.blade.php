...
<div class="row">
    ...
    <form id="" class="sky-form">
        <header>Уточнение: [на карте тык на треугольничек и выделяй область и потом жми "Отправить"
        и потом выделенную область можно увидеть на "Мои поиски"].
        Как разберусь с геометрией - будут показаны пересечения областей на карте - тип совпало чтото.
        </header>
